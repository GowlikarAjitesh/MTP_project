...
def main(args):
    ...
    points, labels = load_txt(args.txt_path)
    ...
    with torch.inference_mode(), torch.autocast("cuda", dtype=torch.float16):
        ...
        _, _, masks = predictor.add_new_points_or_box(state, points=points, labels=labels, frame_idx=0, obj_id=0)
